...
class OneEngine{
	...
	public function theme_init() {
		...
		$t_labels = array(
			'name'               => _x( 'Speakers', 'post type general name', 'oneengine' ),
			'singular_name'      => _x( 'Speaker', 'post type singular name', 'oneengine' ),
			'menu_name'          => _x( 'Speakers', 'admin menu', 'oneengine' ),
			'name_admin_bar'     => _x( 'Team', 'add new on admin bar', 'oneengine' ),
			'add_new'            => _x( 'Add New', 'Speaker', 'oneengine' ),
			'add_new_item'       => __( 'Add New Speaker', 'oneengine' ),
			'new_item'           => __( 'New Speaker', 'oneengine' ),
			'edit_item'          => __( 'Edit Speaker', 'oneengine' ),
			'view_item'          => __( 'View Speaker', 'oneengine' ),
			'all_items'          => __( 'All Speakers', 'oneengine' ),
			'search_items'       => __( 'Search Speakers', 'oneengine' ),
			'parent_item_colon'  => __( 'Parent Speakers:', 'oneengine' ),
			'not_found'          => __( 'No Speakers found.', 'oneengine' ),
			'not_found_in_trash' => __( 'No Speakers found in Trash.', 'oneengine' ),
		);
		...
		$cp_labels = array(
			'name'               => _x( 'Corporate Partners', 'post type general name', 'oneengine' ),
			'singular_name'      => _x( 'Partner', 'post type singular name', 'oneengine' ),
			'menu_name'          => _x( 'Corporate Partners', 'admin menu', 'oneengine' ),
			'name_admin_bar'     => _x( 'Partner', 'add new on admin bar', 'oneengine' ),
			'add_new'            => _x( 'Add New', 'Partner', 'oneengine' ),
			'add_new_item'       => __( 'Add New Partner', 'oneengine' ),
			'new_item'           => __( 'New Partner', 'oneengine' ),
			'edit_item'          => __( 'Edit Partner', 'oneengine' ),
			'view_item'          => __( 'View Partner', 'oneengine' ),
			'all_items'          => __( 'All Partners', 'oneengine' ),
			'search_items'       => __( 'Search Partners', 'oneengine' ),
			'parent_item_colon'  => __( 'Parent Partners:', 'oneengine' ),
			'not_found'          => __( 'No Partners found.', 'oneengine' ),
			'not_found_in_trash' => __( 'No Partners found in Trash.', 'oneengine' ),
		);
		...
		register_post_type( 'corp', $cp_args );

		$pp_labels = array(
			'name'               => _x( 'Patrons', 'post type general name', 'oneengine' ),
			'singular_name'      => _x( 'Patron', 'post type singular name', 'oneengine' ),
			'menu_name'          => _x( 'Patrons', 'admin menu', 'oneengine' ),
			'name_admin_bar'     => _x( 'Patron', 'add new on admin bar', 'oneengine' ),
			'add_new'            => _x( 'Add New', 'Patron', 'oneengine' ),
			'add_new_item'       => __( 'Add New Patron', 'oneengine' ),
			'new_item'           => __( 'New Patron', 'oneengine' ),
			'edit_item'          => __( 'Edit Patron', 'oneengine' ),
			'view_item'          => __( 'View Patron', 'oneengine' ),
			'all_items'          => __( 'All Patrons', 'oneengine' ),
			'search_items'       => __( 'Search Patrons', 'oneengine' ),
			'parent_item_colon'  => __( 'Parent Patrons:', 'oneengine' ),
			'not_found'          => __( 'No Patrons found.', 'oneengine' ),
			'not_found_in_trash' => __( 'No Patrons found in Trash.', 'oneengine' ),
		);
		...
		register_post_type( 'patron', $pp_args );
		...
		$nsp_t_labels = array(
			'name'               => _x( 'Team', 'post type general name', 'oneengine' ),
			'singular_name'      => _x( 'Team', 'post type singular name', 'oneengine' ),
			'menu_name'          => _x( 'Members', 'admin menu', 'oneengine' ),
			'name_admin_bar'     => _x( 'Team', 'add new on admin bar', 'oneengine' ),
			'add_new'            => _x( 'Add New', 'Member', 'oneengine' ),
			'add_new_item'       => __( 'Add New Member', 'oneengine' ),
			'new_item'           => __( 'New Member', 'oneengine' ),
			'edit_item'          => __( 'Edit Member', 'oneengine' ),
			'view_item'          => __( 'View Member', 'oneengine' ),
			'all_items'          => __( 'All Members', 'oneengine' ),
			'search_items'       => __( 'Search Members', 'oneengine' ),
			'parent_item_colon'  => __( 'Parent Members:', 'oneengine' ),
			'not_found'          => __( 'No Members found.', 'oneengine' ),
			'not_found_in_trash' => __( 'No Members found in Trash.', 'oneengine' ),
		);
		...
		register_post_type( 'nsp_team', $nsp_t_args );
	...
	public function et_load_portfolio(){
		...
		$html = '<div class="mask-color-port">
				...
				<div class="port-data">
					<div class="row">
						<div class="col-md-4 port-thumb">
							<div class="thumbnail-img">
								'.get_the_post_thumbnail( $portfolio->ID, 'portfolio-large' ).'
							</div>
						</div>
						<div class="col-md-8 port-excerpt">
