...
// CLEAR BLOCK
if( ! class_exists( 'OE_PPartner_Block' ) ) :

class OE_PPartner_Block extends AQ_Block {

	function __construct() {
		$block_options = array(
			'name' => __( 'ET Patron/Partner', 'oneengine'),
			'size' => 'span12',
		);
		
		//create the block
		parent::__construct('OE_PPartner_Block', $block_options);
	}
	...
	function block($instance) {
		...
		?>
				<div class="et-team-post height-width-auto item <?php echo $animation_effect ?>" <?php echo $duration_effect ?>>
	            	...
	            	<div class="image-team-wrapper" data-content="<?php echo $post->post_content ?>" data-title="<?php echo $post->post_title ?>">
 	...
 	function before_block($instance) {
		extract($instance);
		echo 	'<div id="patron_partners_wrapper" class="team-wrapper animation-wrapper col-md-10 col-md-offset-1" >';
...
aq_register_block( 'OE_PPartner_Block' );
endif;
