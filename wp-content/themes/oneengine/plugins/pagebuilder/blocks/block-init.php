...
include_once ( ONEENGINE_LIB_BLOCK_DIR . 'corporate-partners.php');
include_once ( ONEENGINE_LIB_BLOCK_DIR . 'patrons-partners.php');
include_once ( ONEENGINE_LIB_BLOCK_DIR . 'nsp-team.php');
?>
